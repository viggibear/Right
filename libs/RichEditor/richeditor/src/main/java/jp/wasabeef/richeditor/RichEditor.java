...
public class RichEditor extends WebView {
    ...
    public void setText(String contents){
        ...
        exec("javascript:RE.setText('" + contents + "');");
    }
    ...
    public void setLineHeight(double height) {
        exec("javascript:RE.setLineHeight('" + Double.toString(height) + "');");
    }

    public void highlightWords(String text){
        exec("javascript:cleanHighlight('" + text + "');");
    }

    public void removeHighlights(){
        exec("javascript:removeHighlights(RE.editor);");
    }
